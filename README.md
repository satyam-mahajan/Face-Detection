...
## About Project
In this project, we used medapipe, an open source Python library for detecting and tracking faces. To make it more accessible, we deployed it on the internet using Heroku. For the backend, we used Flask, and for the front end, we used Bootstrap and HTML. You can check the deployment [here](https://face1-detection.herokuapp.com/) !
